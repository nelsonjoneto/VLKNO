...
display_game([PlayerTurn, Board, P1C1, P1C2, P2C1, P2C2, MaxStackSize, IsMoving, Player1Type, Player2Type, Player1Name, Player2Name]) :-
...
format_cell(Cell, Row, Col, P1C1, P1C2, P2C1, P2C2, MaxStackSize) :-
    ( (Row, Col) = P1C1 -> format_piece('-W1-', MaxStackSize)
    ; (Row, Col) = P1C2 -> format_piece('-W2-', MaxStackSize)
    ; (Row, Col) = P2C1 -> format_piece('-B1-', MaxStackSize)
    ; (Row, Col) = P2C2 -> format_piece('-B2-', MaxStackSize)
...
stones_at_position(Board, (Row, Col), Stones) :-
    nth1(Row, Board, BoardRow),
