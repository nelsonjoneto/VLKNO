...
Description: Displays the current game state, including the board, pieces, stones (including the stacks occupied by pieces), 
and the current player. The display will function for all board sizes and heights of stacks of stones.
*/
...
/*
display_board(+Board, +P1C1, +P1C2, +P2C1, +P2C2)
Description: Displays the board with the current positions of the pieces.
*/
display_board(Board, P1C1, P1C2, P2C1, P2C2) :-
    length(Board, N),
...
Description: Displays a row of the board.
*/
...
Description: Displays a cell of the board.
*/
...
/*
format_cell(+Cell, +Position, +P1C1, +P1C2, +P2C1, +P2C2, +MaxStackSize)
Description: Formats a cell for display based on its content.
*/
format_cell(0, _, _, _, _, _, MaxStackSize) :-
    format_lava(MaxStackSize).
format_cell(_, P1C1, P1C1, _, _, _, MaxStackSize) :-
    format_piece('-W1-', MaxStackSize).
format_cell(_, P1C2, _, P1C2, _, _, MaxStackSize) :-
    format_piece('-W2-', MaxStackSize).
format_cell(_, P2C1, _, _, P2C1, _, MaxStackSize) :-
    format_piece('-B1-', MaxStackSize).
format_cell(_, P2C2, _, _, _, P2C2, MaxStackSize) :-
...
/*
format_lava(+MaxStackSize)
Description: Formats an empty cell (the floor is lava!).
*/
format_lava(MaxStackSize) :-
...
Description: Formats a piece for display.
*/
format_piece(Piece, MaxStackSize) :-
...
Description: Formats a stack for display.
*/
format_stack(Stack, MaxStackSize) :-
...
/*
print_separator(+MaxRowDigits, +TotalWidth)
Description: Prints a separator line for the board.
*/
print_separator(MaxRowDigits, TotalWidth) :-
    nl,
...
Description: Prints the column numbers above the cells.
*/
print_column_numbers(CurrentCol, NumCols, PaddingBeginning, PaddingEnd) :-
    CurrentCol =< NumCols,
...
/*
display_stones(+Board, +P1C1, +P1C2, +P2C1, +P2C2)
Description: Displays the number of stones stacked in each occupied position by each piece.
*/
display_stones(Board, P1C1, P1C2, P2C1, P2C2) :-
...
/*
stones_at_position(+Board, +Position, -Stones)
Description: Gets the number of stones at a specific position.
*/
...
/*
display_board_size
Description: Displays the board size menu.
*/
display_board_size :-
    nl,
    write('====================================='), nl,
...
Description: Displays the difficulty menu for PC1.
*/
display_difficulty_pc1 :-
    nl,
    write('====================================='), nl,
...
Description: Displays the difficulty menu for PC2.
*/
display_difficulty_pc2 :-
    nl,
    write('====================================='), nl,
